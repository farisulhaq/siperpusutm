    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="container  w-50">
                <div class="card p-3">
                    <form action="{{ route('admin.jurusans.update',$jurusan->kode) }}" method="post">
                        @csrf
                        @method('patch')
                        <!-- FAKULTAS -->
                        <div class="form-group">
                            ...
                            <select class="form-control" name="kode_fak" id="kode_fak">
                                <option value="{{ $jurusan->fakultas->kode }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_jur" name="nama_jur"
                                value="{{ old('nama_jur')?? $jurusan->nama_jur}}" required>
                        </div>
                        @error('nama_jur')
                        <div class="text-danger">
                            {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kode" name="kode" maxlength="2"
                                value="{{ old('kode') ?? $jurusan->kode}}" readonly>
                        </div>
                        @error('kode')
                        <div class="text-danger">
                            {{ $message }}
